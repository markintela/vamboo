...
-- =========================================================
-- PARTE 4 — DESLOCAMENTO (tipos de transporte além de trem/barco,
-- com dados de voo opcionais) + PAPEL DE ADMINISTRADOR
-- =========================================================
...
-- is_trip_admin: mesmo motivo do is_trip_owner acima — SECURITY DEFINER
-- pra não recriar o ciclo de recursão de RLS.
...
-- =========================================================
-- PARTE 5 — PESSOAS DA VIAGEM = COLABORADORES (nome + foto do perfil)
-- =========================================================
...
-- de outro usuário — só quando os dois compartilham alguma trip.
...
-- Foto de perfil: arquivos de avatar (path "<userId>/avatar-...") ficam
-- no mesmo bucket dos documentos pessoais, mas com prefixo exclusivo —
-- só a rota de upload de foto de perfil gera nome assim. Por isso dá
-- pra liberar só esses arquivos pra quem compartilha uma trip, sem
-- abrir acesso a documentos (RG/passaporte) de ninguém.
...
-- =========================================================
-- PARTE 7 — GALERIA DE FOTOS DA TRIP (upload direto)
-- =========================================================
